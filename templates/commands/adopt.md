...
This legacy command is a rename notice only. Its workflow is now `rpi-adopt`.

- Claude direct installation: invoke `/rpi-adopt`.
- Claude plugin installation: invoke `/cc-rpi:rpi-adopt`.
- Codex direct installation: invoke `$rpi-adopt` or select the skill.
