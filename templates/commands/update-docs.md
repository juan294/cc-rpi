...
This legacy command is a rename notice only. Its workflow is now `rpi-update-docs`.

- Claude direct installation: invoke `/rpi-update-docs`.
- Claude plugin installation: invoke `/cc-rpi:rpi-update-docs`.
- Codex direct installation: invoke `$rpi-update-docs` or select the skill.
