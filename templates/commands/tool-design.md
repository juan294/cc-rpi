...
This legacy command is a rename notice only. Its workflow is now `rpi-tool-design`.

- Claude direct installation: invoke `/rpi-tool-design`.
- Claude plugin installation: invoke `/cc-rpi:rpi-tool-design`.
- Codex direct installation: invoke `$rpi-tool-design` or select the skill.
