...
This legacy command is a rename notice only. Its workflow is now `rpi-brainstorm`.

- Claude direct installation: invoke `/rpi-brainstorm`.
- Claude plugin installation: invoke `/cc-rpi:rpi-brainstorm`.
- Codex direct installation: invoke `$rpi-brainstorm` or select the skill.
