...
This legacy command is a rename notice only. Its workflow is now `rpi-detach`.

- Claude direct installation: invoke `/rpi-detach`.
- Claude plugin installation: invoke `/cc-rpi:rpi-detach`.
- Codex direct installation: invoke `$rpi-detach` or select the skill.
