...
This legacy command is a rename notice only. Its workflow is now `rpi-validate`.

- Claude direct installation: invoke `/rpi-validate`.
- Claude plugin installation: invoke `/cc-rpi:rpi-validate`.
- Codex direct installation: invoke `$rpi-validate` or select the skill.
