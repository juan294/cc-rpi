...
This legacy command is a rename notice only. Its workflow is now `rpi-release`.

- Claude direct installation: invoke `/rpi-release`.
- Claude plugin installation: invoke `/cc-rpi:rpi-release`.
- Codex direct installation: invoke `$rpi-release` or select the skill.
