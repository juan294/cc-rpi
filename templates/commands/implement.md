...
This legacy command is a rename notice only. Its workflow is now `rpi-implement`.

- Claude direct installation: invoke `/rpi-implement`.
- Claude plugin installation: invoke `/cc-rpi:rpi-implement`.
- Codex direct installation: invoke `$rpi-implement` or select the skill.
