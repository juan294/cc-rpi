...
- Claude direct installation: invoke `/rpi-explore-release`.
- Claude plugin installation: invoke `/cc-rpi:rpi-explore-release`.
- Codex direct installation: invoke `$rpi-explore-release` or select the skill.
