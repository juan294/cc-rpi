...
This legacy command is a rename notice only. Its workflow is now `rpi-update`.

- Claude direct installation: invoke `/rpi-update`.
- Claude plugin installation: invoke `/cc-rpi:rpi-update`.
- Codex direct installation: invoke `$rpi-update` or select the skill.
