...
The blueprint includes 56 operational rules learned from real sessions. These aren't theoretical — they're patterns that caused actual failures and wasted time. Examples:
...
| Error patterns | `patterns/agent-errors.md` | 52 documented errors with symptoms and solutions |
| Operational rules | `patterns/quick-reference.md` | 56 rules to prevent known mistakes |
